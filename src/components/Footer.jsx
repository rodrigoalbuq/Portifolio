...
export default function Footer() {
  ...
  return (
    <Wrapper>
      <Container>
        <span className="footer-copy">© {new Date().getFullYear()} {t.name}</span>
        <Links className="footer-links">
          <IconLink href="https://github.com/rodrigoalbuq" target="_blank" rel="noreferrer" aria-label="GitHub" title="GitHub">
          ...
          <IconLink as={Link} to="/contato" aria-label={lang === 'pt' ? 'Email' : 'Email'} title={lang === 'pt' ? 'Email' : 'Email'}>
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true">
              <rect x="3" y="5" width="18" height="14" rx="2" />
              <path d="M3 7l9 6 9-6" />
            </svg>
          </IconLink>
          <IconLink href="https://wa.me/5581994236672" target="_blank" rel="noreferrer" aria-label={lang === 'pt' ? 'WhatsApp' : 'WhatsApp'} title={lang === 'pt' ? 'WhatsApp' : 'WhatsApp'}>
            <FaWhatsapp />
          </IconLink>
          <IconLink href="https://www.linkedin.com/in/rodrigoalvalbq/" target="_blank" rel="noreferrer" aria-label="LinkedIn" title="LinkedIn">
            <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
