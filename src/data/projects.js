export const projects = [
    {
        name: 'Cinelista',
        description:
            'Aplicação para explorar filmes, com busca, detalhes e lista personalizada.',
    ...
    },
    {
        ...
        techs: ['HTML5', 'CSS3', 'JavaScript', 'Service Worker API', 'Web Storage', 'Node.js', 'PWA', 'Vercel'],
        repo: 'https://github.com/rodrigoalbuq/Diario-de-Bordo',
        demo: 'https://diario-de-bordo-tawny.vercel.app/',
        image: '/diario-de-bordo.png',
    },
    {
        name: 'Estilo Livre',
        description:
